...
export default function App() {
  ...
  const calculateCoordinates = () => {
    ...
    // Código do worker inline baseado na edição
    const workerCode = edition === 'java' ? `
      // Java Edition Random Generator
      class JavaRandom {
        constructor(seed) {
    ...
    ` : `
      // Bedrock Edition Random Generator
      class BedrockRandom {
        constructor(seed) {
            ...
            <div className="flex gap-2">
              <button
                ...
                className={`px-3 py-1 rounded text-sm font-medium transition-all ${
                  gridSize === 5 ? 'bg-purple-600 text-white' : 'bg-gray-700 text-gray-300 hover:bg-gray-600'
                }`}
              >
                5×5
              </button>
              <button
                ...
                className={`px-3 py-1 rounded text-sm font-medium transition-all ${
                  gridSize === 7 ? 'bg-purple-600 text-white' : 'bg-gray-700 text-gray-300 hover:bg-gray-600'
                }`}
              >
                7×7
              </button>
  ...
  <footer className="fixed bottom-0 left-0 right-0 bg-gradient-to-t from-gray-900 to-transparent backdrop-blur-md border-t border-purple-500/20 py-4">
    <div className="max-w-7xl mx-auto px-4 text-center">
      ...
      <p className="text-xs text-gray-500 mt-1">
        Motor de busca multi-core • {edition === 'java' ? 'Java Edition' : 'Bedrock Edition'}
      </p>
    </div>
  </footer>
</div>
